		...
		<div class="row chat-window col-xs-5 col-md-5" id="chat_window_1"
			...
			<div class="col-xs-12 col-md-12">
				<div class="panel panel-default">
					...
					<!-- Creating container for displaying the chat messages (request and response both). -->
...
function insertChat(who, text, time = 0){
    ...
    if (who == "me"){
        ...
        //Calling the ConversationController                    	   
        $.post("./chat",
           	    {
        	inp: text
           	    },
...
$(".mytext").on("keyup", function(e){
    ...
    if (e.which == 13){
        var text = $(this).val();
        if (text !== ""){
            insertChat("me", text); //Calling insertChat() method              
            $(this).val('');
        }
    }
});
